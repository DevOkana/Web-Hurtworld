		 ...
		 $("#register-form").validate({
		  ...
		  rules:
		  {
		   ...
		   messages:
		   {
				...
				remote : "Email ya existe por favor ingrese otro válido"
			},
				ip:{
		   ...
		   function submitForm(){
			   ...
			   .done(function(data){
			   		...
			   		$('#btn-signup').html('<img src="img/ajax-loader.gif" /> &nbsp; Registrando...').prop('disabled', true);
